...
We adopt the GNN--CNN architecture for MU-\gls{MIMO}
...
denote the true and estimated channel vectors respectively. The objective is
\begin{align}
  \label{eq:total_loss}
    \mathcal{L}
...
warm-start from that checkpoint \cite{kingma2014adam}.
