...
\begin{figure*}[t]
    ...
    \gls{CGNN} stage after global $50\%$ pruning. Its y-axis labels
...
$\sim0.2$\,dB of LMMSE--K-Best.\footnote{LS--LMMSE and LMMSE--K-Best use
...
LS--LMMSE by more than $2$\,dB. \emph{Thus, FP4 tolerates 50\% pruning
